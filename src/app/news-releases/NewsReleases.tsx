...
const NewsReleasesComponent: React.FC<IPOPageProps> = ({ serverData }) => {
  const { documents, other, loading, error } = useIPO("News Releases");
...
export default NewsReleasesComponent;
